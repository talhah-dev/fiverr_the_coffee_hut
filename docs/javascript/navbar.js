                ...
                <div class="flex w-full items-center justify-between xl:gap-32 gap-20">
                    <a data-aos="fade-right" href="/index.html"
                        class="block text-white text-2xl font-semibold tracking-wide italic">
                           <img src="/docs/assets/images/logo.png" class="xl:h-20 h-16" alt="logo">
                    </a>
                    <div class="flex items-center gap-3">
                        <div data-aos="fade-left" class="xl:flex items-center gap-10 hidden">
                            <ul id="navbarLinks" class="xl:flex hidden items-center text-zinc-900 gap-10">
        ...
        <div id="mobileMenu"
            ...
            <div class="p-6">
                <ul class="flex relative z-50 text-[#1D2939] flex-col gap-7">
                    ...
                    <li><a href="/food.html"
                            class="hover:opacity-60 mobileMenuCloseBtn tracking-wide  transition-all duration-500 text-nowrap">Food Menu</a>
                    </li>
                    <li><a href="/drink.html"
                            class="hover:opacity-60 mobileMenuCloseBtn tracking-wide  transition-all duration-500 text-nowrap">Drink Menu</a>
                    </li>
                </ul>
                <div class="mt-5 flex flex-col gap-3">
                    <a href="/contact.html"
                        class="w-full tracking-wider inline-flex items-center justify-center py-3 px-7 text-base font-medium text-center text-white bg-[#1e3b4b] rounded-sm border-2 border-[#1e3b4b] text-nowrap hover:opacity-70 transition-all duration-500">
                            contact Us
                    </a>
                </div>
            </div>
